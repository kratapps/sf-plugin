...
export function asRelativePaths<T extends FileResponse | FileResponseSuccess | FileResponseFailure>(fileResponses: T[]): T[] {
 ...
 */
export function sortFileResponses<T extends FileResponse | FileResponseSuccess | FileResponseFailure>(fileResponses: T[]): T[] {
