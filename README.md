...
```
USAGE
  $ sf kratapps sfdmu csv2yaml --sfdmu-dir <value> [--json] [--preserve-existing] [--config-file <value>] [--source-dir
...
```
USAGE
  $ sf kratapps sfdmu yaml2csv --source-dir <value> [--json] [--config-file <value>] [--sfdmu-dir <value>] [--operations
    <value>]
...
FLAGS
  ...
  --source-dir=<value>   (required) [default: data] Directory containing records generated by `sf kratapps data sfdmu
                         csv2yaml` command.
